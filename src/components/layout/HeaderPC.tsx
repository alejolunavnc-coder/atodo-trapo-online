  ...
  return (
    <>
      ...
      <div className="hidden bg-blue-950 text-[12px] font-medium tracking-wide text-white/95 md:block">
        <div className="mx-auto grid h-8 max-w-7xl grid-cols-[1fr_auto_1fr] items-center px-6">
          ...
          <div className="flex items-center justify-center whitespace-nowrap text-[12px] font-medium">
            <span>
              🕒 {localConfig.horarios.lunesASabadoCorto}
            </span>

            <span className="mx-4 opacity-50">•</span>

            <span>
              {localConfig.horarios.domingoCorto}
            </span>
          </div>
      ...
      <header className="sticky top-0 z-50 hidden border-b border-gray-100 bg-white/95 shadow-[0_8px_30px_rgba(15,23,42,0.10)] backdrop-blur-md md:block">
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between gap-8 px-6">
          ...
          <div className="flex min-w-0 max-w-4xl flex-1">
            <input
              type="text"
              ...
              className="h-11 w-full min-w-0 rounded-l-full border border-gray-200 px-6 text-[15px] text-gray-700 outline-none transition placeholder:text-gray-400 focus:border-blue-700"
            />

            <button
              type="button"
              aria-label="Buscar productos"
              className="flex h-11 w-12 shrink-0 items-center justify-center rounded-r-full bg-blue-950 text-white transition hover:bg-blue-900"
            >
              🔍
            </button>
          </div>
          ...
          <div className="flex shrink-0 items-center gap-6 text-[13px] text-slate-700">
            <button
              type="button"
              onClick={() =>
              ...
              className="flex items-center gap-2 whitespace-nowrap transition hover:text-blue-800"
            >
              <BadgePercent
                size={18}
                strokeWidth={2}
            ...
            <button
              ...
              className={`relative flex items-center gap-2 whitespace-nowrap transition hover:text-blue-800 ${
                carritoAnimado
